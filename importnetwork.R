...
packages <- c("dplyr","httr","jsonlite","stringr")
...
exportNetwork(filename=paste0(sprintf("Outputs/Session-%s/Networks/",datetime),paste(snw_scz,datetime, sep = " - ")),"CX", network = snw_scz, overwriteFile=FALSE)
...
exportNetwork(filename=paste0(sprintf("Outputs/Session-%s/Networks/",datetime),paste(snw_scz_filtered,datetime, sep = " - ")),"CX", network = snw_scz_filtered, overwriteFile=FALSE)
...
exportNetwork(filename=paste0(sprintf("Outputs/Session-%s/Networks/",datetime),paste(snw_scz_filtered_string,dateimte,sep= " - ","CX",network=snw_scz_filtered_string,overwriteFile=FALSE)))
...
exportNetwork(filename=paste0(sprintf("Outputs/Session-%s/Networks/",datetime),paste(snw_scz_filtered_string_clustered,dateimte,sep= " - ","CX",network=snw_scz_filtered_string_clustered,overwriteFile=FALSE)))
...
exportNetwork(filename=paste0(sprintf("Outputs/Session-%s/Networks/",datetime),paste(snw_scz_ext,datetime, sep = " - ")),"CX", network = snw_scz_ext, overwriteFile=FALSE)
